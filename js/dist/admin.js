...
var SettingsModal = _fof_components__WEBPACK_IMPORTED_MODULE_0__["settings"].SettingsModal,
    NumberItem = _fof_components__WEBPACK_IMPORTED_MODULE_0__["settings"].items.NumberItem;
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('cxsquared-signature', function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.extensionSettings['cxsquared-signature'] = function () {
    return flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.modal.show(SettingsModal, {
      tite: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('Xengine-signature.admin.title'),
      items: function items(s) {
        return [m("div", {
          ...
          setting: s,
          label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('Xengine-signature.admin.settings.maximum_image_width.description')
        }), m(NumberItem, {
          name: "Xengine-signature.maximum_image_height",
          setting: s,
          label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('Xengine-signature.admin.settings.maximum_image_height.description')
        }), m(NumberItem, {
          name: "Xengine-signature.maximum_image_count",
          setting: s,
          label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('Xengine-signature.admin.settings.maximum_image_count.description')
        }), m(NumberItem, {
          name: "Xengine-signature.maximum_char_limit",
          setting: s,
          label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('Xengine-signature.admin.settings.maximum_char_limit.description')
        }))];
      }
    });
  };
